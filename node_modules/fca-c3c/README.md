...
<a href="https://www.npmjs.com/package/fca-c3c"><img alt="npm version" src="https://img.shields.io/npm/v/fca-c3c.svg?style=flat-square"></a>
<img alt="version" src="https://img.shields.io/github/package-json/v/fca-c3c?label=github&style=flat-square">
<a href="https://www.npmjs.com/package/fca-c3c"><img src="https://img.shields.io/npm/dm/fca-c3c.svg?style=flat-square" alt="npm downloads"></a>
...
## Install
If you just want to use fca-c3c, you should use this command:
```bash
npm install fca-fca-c3c
```
It will download `fca-c3c` from NPM repositories

### Bleeding edge
If you want to use bleeding edge (directly from github) to test new features or submit bug report, this is the command for you:
```bash
npm install fca-fca-c3c/fca-c3c
```
